...
- **Real-world confirmation at true target scale**: monlum ran a ~2,000km² bounding box (central Tokyo through most of the 23 wards, full detail — real buildings and roads, not just terrain) on his own 32GB machine. It completed in about 25 minutes using roughly 20GB RAM, no crash, and loaded and played correctly in Minecraft. That's an area upstream Arnis cannot attempt at all — the entire reason this fork exists.
